...
<body>
    <main>
        ...
        <section class="container">
            <h2 class="my-2">Actualizar usuario</h2>
            <hr>
            <div class="w-50">
                <form action="./update_usuario.php" method="post">
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                    <div class="form-floating mb-3">
                        <input type="text" name="fullname" class="form-control" id="floatFullname" placeholder="Fullname" value="<?php echo $response["fullname"]; ?>">
                        <label for="floatFullname">Fullname</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" name="username" class="form-control" id="floatUsername" placeholder="username" value="<?php echo $response["username"]; ?>">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <label for="floatPassword">Role</label>
                    </div>
